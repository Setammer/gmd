...
const browserOption = usePairingCode ? ['Ubuntu', 'Chrome', '20.0.04'] : ['Recbart Bot', 'Chrome', '3.0.0'];
...
cfont.say('<- Gumdramon ->', {
 ...
 console.log(chalk.magentaBright.bold(` ‎ ‎    Recbart Bot • coppyright©2021`))
    console.log(chalk.white('     ‎ ‎_____________________________________\n'))  
